...
public class BrandFragment extends Fragment {
    ...
    public void initView(View rootView) {
        ...
        if (recyclerView != null) {
            ...
            mRefreshLayout.setOnRefreshListener(refreshLayout -> refreshLayout.getLayout().postDelayed(new Runnable() {
                @Override
                public void run() {
                    o_page = 1;
            ...
            //上拉加载
            mRefreshLayout.setOnLoadMoreListener(refreshLayout -> refreshLayout.getLayout().postDelayed(new Runnable() {
                @Override
                public void run() {
    ...
    public void getData(int page, final int flag, final RefreshLayout refreshLayout) {
        EasyHttp.get("index/BrandController/showBrandList").params("page", page + "")
