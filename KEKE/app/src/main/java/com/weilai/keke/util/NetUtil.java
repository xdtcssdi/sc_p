...
public class NetUtil {
    ...
    public static void checkNetwork(final Activity activity) {
        if (!NetUtil.isNetworkAvalible(activity)) {
            ...
            new AlertDialog.Builder(activity).setIcon(R.drawable.icon_see_pass).setTitle("网络状态提示").setView(msg).setPositiveButton("确定", new DialogInterface.OnClickListener() {
