...
import com.example.amicool.fragment.FragmentAttention1;
import com.example.amicool.fragment.FragmentAttention2;
import com.example.amicool.fragment.FragmentAttention3;
import com.example.amicool.fragment.FragmentAttention4;
import com.example.amicool.fragment.FragmentAttention5;
...
public class UserRes extends AppCompatActivity {
    ...
    private FragmentAttention1 fragment1;
    private FragmentAttention2 fragment2;
    private FragmentAttention3 fragment3;
    private FragmentAttention4 fragment4;
    private FragmentAttention5 fragment5;
    @Override
    ...
    private class MyPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) { //根据位置返回体某个导航上对应的Fragm具ent
            switch (position) {
                case 0:
                    if (fragment1 == null) {
                        fragment1 = new FragmentAttention1();
                    }
                    return fragment1;
                case 1:
                    if (fragment2 == null) {
                        fragment2 = new FragmentAttention2();
                    }
                    return fragment2;
                case 2:
                    if (fragment3 == null) {
                        fragment3 = new FragmentAttention3();
                    }
                    return fragment3;
                case 3:
                    if (fragment4 == null) {
                        fragment4 = new FragmentAttention4();
                    }
                    return fragment4;
                case 4:
                    if (fragment5 == null) {
                        fragment5 = new FragmentAttention5();
                    }
                    return fragment5;
                default:
                    return null;
