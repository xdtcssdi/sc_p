...
import com.example.amicool.adapter.ATwareAdapter;
import com.example.amicool.bean.TwareBean;
import com.example.amicool.iface.AttentionListListener;
import com.example.amicool.model.ATwareModel;

import java.util.List;

public class FragmentAttention2 extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        aTwareModel.getResultList("tware", page, sessionID, userId,listListener);
