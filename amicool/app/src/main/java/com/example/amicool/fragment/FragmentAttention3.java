...
import com.example.amicool.model.AArticleModel;

import java.util.List;

public class FragmentAttention3 extends BaseFragment{
    ...
    AttentionListListener<ArticleBean> listListener = new AttentionListListener<ArticleBean>() {
        @Override
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        AArticleModel aArticleModel = new AArticleModel();
        aArticleModel.getResultList("article", page, sessionID, userId,listListener);
