...
import com.example.amicool.model.ATcaseModel;

import java.util.List;

public class FragmentAttention4 extends BaseFragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        aTcaseModel.getResultList("tcase", page, sessionID, userId,listListener);
