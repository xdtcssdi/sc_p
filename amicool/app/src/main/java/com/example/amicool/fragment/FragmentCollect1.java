...
import com.example.amicool.adapter.CVideoAdapter;
...
import com.example.amicool.model.CVideoModel;

import java.util.List;

import static android.content.Context.MODE_PRIVATE;

public class FragmentCollect1 extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        cVideoModel.getResultList("video", page, sessionID, listListener);
