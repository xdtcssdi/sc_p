        ...
        <div class="span2">
            ...
            <div class="main-left-col">
                ...
                <ul class="side-nav">
                    ...
                    <li  class="active"><a href="videotype_manager.php"><i class="icon-bullhorn"></i> 视频类型管理 </a></li>
                </ul>
                    ...
                    <div class="span10">
                        ...
                        <div class="slate">
                            ...
                            <table class="orders-table table">
                                ...
                                $data = getVideoTypeDate($page, $num, $kw);
                                            
                                while ($row = mysqli_fetch_assoc($data[0])) {
                                    echo "<tr>
                                    <td><a href=\"#\" onclick='openEditDialog(\"" . $row['typename'] . "\",\"" . $row['tid'] . "\");'>" . $row['tid'] . "</a><br/></td>
                                    <td>" . $row['typename'] . "</td>". "</tr>";
                                }
                                ?>
                    ...
                    <div class="span5">
                        ...
                        <div class="pagination pull-left">
                            <ul>
                                ...
                                echo '<li><a href="videotype_manager.php?page=' . $prev . '&num=' . $num .'&search='.$kw.'">Prev</a></li>';
                                for ($i = 1; $i <= $data[1]; ++$i) {
                                    echo '<li ';
                                    if ($i == $page) {
                                        echo 'class="active">';
                                    ...
                                    echo '<a href="videotype_manager.php?page=' . $i . '&num=' . $num .'&search='.$kw. '">' . $i . '</a>';
                                    echo '</li>';
                                }
                                echo '<li><a href="videotype_manager.php?page=' . $next . '&num=' . $num .'&search='.$kw. '">Next</a></li>';
            ...
            <form class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <label for="comment">分类</label>
                        <input type="hide" type='text' id='cid'/>
