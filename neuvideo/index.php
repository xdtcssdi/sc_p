...
<nav class="navbar navbar-default" style="background-color: #1E1E1E">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">NeuVideo</a>
        </div>
...
//                 echo '<div class="swiper-slide swiper-slide-center none-effect">
//                 <a href="' . $video_url .'">
//                   <img src="' .$video_pic. '">
//                 </a>
...
//     }
    ...
    ?>
     -->
<section class="pc-banner" style="background-color: #1E1E1E">
  <div class="swiper-container" style="background-color: #1E1E1E">
